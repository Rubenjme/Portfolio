...
<p>This project implements and analyzes search algorithms in a structured navigation environment. BFS, DFS, UCS (Dijkstra), and A* with different heuristics are compared to find optimal routes. Metrics such as cost, path length, and efficiency are evaluated, with results visualized using Matplotlib.</p>
